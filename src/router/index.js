...
* redirect: noredirect           if `redirect:noredirect` will no redirct in the breadcrumb面包屑
* name:'router-name'             the name is used by <keep-alive> (must set!!!)
* meta : {
    role: ['admin','editor']     will control the page role (you can set multiple roles)
    title: 'title'               the name show in submenu and breadcrumb (recommend set)子菜单和面包屑的显示
...
export const asyncRouterMap = [
  {
    ...
    meta: { role: ['admin','zhou','hanxiangxue'] },
    children: [{
      path: 'index',
